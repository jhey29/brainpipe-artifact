import { output } from './snippets/wasm-crate-434e1bb0b24bcf4e/js/wasm_imports.js';
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_output_e029b026214c3973 = function(arg0, arg1) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm_crate_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
